...
namespace ServiceDesk.Controllers
{
    ...
    public partial class EmployeeController : Controller
    {
        ...
        {
            var employees = await _context.Employee.GroupJoin(_context.Ticket.Where(ticket => ticket.Open), employee => employee.Id, ticket => ticket.EmployeeId, (employee, tickets) => new EmployeeDetails { Employee = employee, Tickets = tickets, OpenTicketCount = tickets.Count() }).OrderByDescending(details => details.Tickets.Count()).ToListAsync();
